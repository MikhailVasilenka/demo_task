...
public class ShoppingCartServiceTest {
	...
	public void calculatesDiscountPrice() {
		...
		BigDecimal result = service.calculateTotalPriceWithDiscount(cart, BigDecimal.valueOf(10), 5);
	...
	public void calculatesDiscountCategoryPrice() {
		...
		BigDecimal result = service.calculateCategoryTotalPriceWithDiscount(cart.getProducts(), BigDecimal.valueOf(10), 3);
